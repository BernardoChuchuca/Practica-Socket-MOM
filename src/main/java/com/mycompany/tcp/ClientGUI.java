...
public class ClientGUI extends JFrame {
    ...
    private Queue<String> colas = new ArrayDeque<>();
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        // Cuando se hace clic en el botón de enviar:
                         ...
                         amigo = input;
                        String message = input.toUpperCase() + " : " + crypto.decrypt(crypto.encrypt(messageField.getText(), "1"), "1"); // Se obtiene el texto del campo de entrada.
            ...
            sendButton2.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    // Cerrar la ventana actual (dispose())
                       ...
                       for (String mens : colas){
                            chatArea.append(mens+ "\n");
